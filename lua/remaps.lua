...
mapper.set("n", "<C-h>", "<C-w>h", { desc = "Move focus to the left window" })
mapper.set("n", "<C-l>", "<C-w>l", { desc = "Move focus to the right window" })
mapper.set("n", "<C-j>", "<C-w>j", { desc = "Move focus to the lower window" })
mapper.set("n", "<C-k>", "<C-w>k", { desc = "Move focus to the upper window" })
